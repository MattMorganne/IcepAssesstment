 ...
 * @author Morganne
 */
public class AddPostCompany extends HttpServlet {
  ...
  <button type="submit" class="btn btn-primary btn-block mb-4">create</button>
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JobPost jobPost = new JobPost(title, description, course, expDate, company.getCode());
            ...
            Logger.getLogger(AddPostCompany.class.getName()).log(Level.SEVERE, null, ex);
        }
