 ...
 * @author Morganne
 */
public class CompanySeelList extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       Company company = (Company) session.getAttribute("company");
        ...
        List<StudentAplication> filteredApplications = filterApplications(applications,jobId,company);
        ...
        RequestDispatcher rd = request.getRequestDispatcher("companySeeList.jsp");
        rd.forward(request, response);
    }

    private List<StudentAplication> filterApplications(List<StudentAplication> applications, Long jobId, Company company) {
        ...
        for (int i = 0; i < applications.size(); i++) {
            ...
            if (jp.getCompanyCode().equalsIgnoreCase(company.getCode()) && jp.getId().equals(jobId)) {
