...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <h1 class="display-4">Please add an internship post</h1>
        <form style="width:40vw; margin-left: 20%; margin-top: 120px" method="POST" action="AddPostCompany.do">
  <!-- Name input -->
  ...
  <div class="form-outline mb-4">
    ...
    <label class="form-label" for="form4Example3">required course</label>
                ...
                <!-- Message input -->
  <div class="form-outline mb-4">
      <input  class="form-control"   rows="4" type="text" id="form4Example7" class="form-control" type="dateate" name="adate"/>
