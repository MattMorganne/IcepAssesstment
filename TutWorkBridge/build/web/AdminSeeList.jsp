                ...
                <div class="col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <a href="UpdateApplication.do?status=false&studId=<%= studs.get(i).getId()%>" class="btn btn-primary">reject</a>
                            <a href="UpdateApplication.do?status=true&studId=<%= studs.get(i).getId()%>" class="btn btn-primary">add to next stage</a>
                        </div>
                    </div>
                </div>
